...
def train_12ECG_classifier(input_directory, output_directory):
    ...
    for i in range(1): # single run instead of 5-fold cv
        args = parse_args()
...
def parse_args():
    ...
    # parser.add_argument('--model_name', type=str, default='seresnet34_1d_ag', help='the name of the model')
    # parser.add_argument('--model_name', type=str, default='seresnet50_1d_ag', help='the name of the model')
    # parser.add_argument('--model_name', type=str, default='sevresnet101_1d_ag', help='the name of the model')
    # parser.add_argument('--model_name', type=str, default='seresnet152_1d_ag', help='the name of the model')
