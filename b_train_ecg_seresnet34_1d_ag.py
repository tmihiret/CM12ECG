...
def parse_args():
    ...
    # basic parameters
    # parser.add_argument('--model_name', choices=['seresnet34_1d_ag', 'seresnet34_1d'], type=str, default='seresnet34_1d_ag', help='the name of the model')
    # parser.add_argument('--data_name', type=str, choices=['ECGag', 'ECG'], default='ECGag', help='the name of the data')
    parser.add_argument('--model_name', choices=['seresnet34_1d_ag', 'seresnet34_1d'], type=str, default='seresnet34_1d', help='the name of the model')
    parser.add_argument('--data_name', type=str, choices=['ECGag', 'ECG'], default='ECG', help='the name of the data')
...
#    parser.add_argument('--label_dir', type=str, default='/Users/michael', help='the directory of the labels')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoint_seresnet34',
...
#    parser.add_argument("--pretrained", type=bool, default=True, help='whether to load the pretrained model')
    ...
    parser.add_argument('--resample', type=str, choices=['linear', 'butterworth'], default='butterworth', help='resampling method [linear, butterworth]')
...
if __name__ == '__main__':
    ...
    if args.model_name.endswith('ag'):
