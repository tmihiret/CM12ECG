...
def nn_forward(model, sigmoid, criterion, inputs, labels):
    logits = model(inputs)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, args.max_epoch):
            ...
            for phase in ['train', 'val']:
                ...
                challenge_metric = self.cal_acc(labels_all, logits_prob_all, threshold=0.2, num_classes=self.num_classes)
