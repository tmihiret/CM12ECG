...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, choices=['seresnet50_1d_ag', 'seresnet50_1d'], default='seresnet50_1d', help='the name of the model')
...
#    parser.add_argument('--label_dir', type=str, default='/Users/michael', help='the directory of the labels')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoint_seresnet50',
