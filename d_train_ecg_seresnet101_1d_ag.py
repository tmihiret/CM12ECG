...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, choices=['seresnet101_1d_ag', 'seresnet101_1d'], default='seresnet101_1d', help='the name of the model')
...
#    parser.add_argument('--label_dir', type=str, default='/Users/michael', help='the directory of the labels')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoint_seresnet101',
                        help='the directory to save the model')
#    parser.add_argument("--pretrained", type=bool, default=True, help='whether to load the pretrained model')
    parser.add_argument('--batch_size', type=int, default=64, help='batchsize of the training process')
    parser.add_argument('--num_workers', type=int, default=16, help='the number of training process')
